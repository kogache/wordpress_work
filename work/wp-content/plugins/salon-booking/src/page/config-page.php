...
?>
			...
			$j("input[name=\"config_week_start\"]").val([<?php echo $this->config_datas['SALON_CONFIG_WEEK_FIRST']; ?>]);
		...
		function fnClickUpdate() {
			...
			$j.ajax({
					...
					data: {
						...
						,"config_week_start":$j("input[name=\"config_week_start\"]:checked").val()
...
?>
		...
		<div id="config_week_start" class="config_item_wrap" >
			<input id="config_week_monday" name="config_week_start" type="radio" style="width:16px;margin:3px 5px 0px 10px;" value="<?php echo Salon_Week::MONDAY; ?>" />
			<label for="config_week_monday"  style="width:auto;margin:5px;text-align:left;"><?php _e('Monday',SL_DOMAIN); ?></label>
			<input id="config_week_sunday" name="config_week_start" type="radio" style="width:16px;margin:3px 5px 0px 10px;" value="<?php echo Salon_Week::SUNDAY; ?>" />
			<label for="config_start_sunday"  style="width:auto;margin:5px;text-align:left;"><?php _e('Sunday',SL_DOMAIN); ?></label>
		</div>
